...
from clovers.core.protocol import check_compatible
...
print(2.1, check_compatible(Literal["str", "int"], Literal["str", "int", "any"]))
print(2.2, check_compatible(Literal["str", "int", "any"], Literal["str", "int"]))
